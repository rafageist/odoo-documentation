...
- Dependencies: [[Odoo 18/Community Addons/product/product|product]], [[Odoo 18/Community Addons/stock/stock|stock]], [[Odoo 18/Community Addons/resource/resource|resource]]
...
mrp_production --> stock_lot : many2one
...
mrp_production --> procurement_group : many2one
...
mrp_workorder --> uom_uom : many2one
...
mrp_workorder --> stock_lot : many2one
...
StockMove --> stock_lot : many2one
StockWarehouseOrderpoint --> mrp_bom : many2one
StockPicking .. mrp_production : many2many
ProcurementGroup --|> mrp_production : one2many
