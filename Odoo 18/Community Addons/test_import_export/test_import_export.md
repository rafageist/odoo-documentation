...
- Version: v18
- Category: community
- Source: odoo/addons/test_import_export
- Dependencies: [[Odoo 18/Community Addons/web/web|web]], [[Odoo 18/Community Addons/base_import/base_import|base_import]], [[Odoo 18/Community Addons/website/website|website]]
...
class Many2String
class ChidToString
class WithRequiredField
class Many2OneRequiredSubfield
...
InheritsChild --> export_inherits_parent : many2one
class "export.m2o.str.child" as export_m2o_str_child
Many2String --> export_m2o_str_child : many2one
class "export.with.required.field" as export_with_required_field
Many2OneRequiredSubfield --> export_with_required_field : many2one
...
PropertyDefinition --|> import_properties : one2many
PropertyDefinition --> import_properties : many2one
class "import.properties.definition" as import_properties_definition
Property --> import_properties_definition : many2one
