...
- `auth_signup_template_user_id`: `Many2one` (comodel `res.users`)
...
res_config_settings --> res_users : auth_signup_template_user_id
@enduml
```

## Navigation

- **Parent:** [[docs/Community Addons/auth_signup/Models]]
