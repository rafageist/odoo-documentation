...
- `serialization_field_id`: `Many2one` (comodel `ir.model.fields`)
- `ttype`: `Selection`
...
title ir.model.fields - Direct Relations
class "ir.model.fields" as ir_model_fields
class "ir.model.fields" as ir_model_fields
ir_model_fields --> ir_model_fields : serialization_field_id
@enduml
```
