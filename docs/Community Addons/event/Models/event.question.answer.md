...
- Source files: `models/event_question_answer.py`
- Python classes: `EventQuestionAnswer`
...
title event.question.answer - Direct Relations
class "event.question.answer" as event_question_answer
class "event.question" as event_question
event_question_answer --> event_question : question_id
@enduml
```
