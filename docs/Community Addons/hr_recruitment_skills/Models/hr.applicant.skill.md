...
- Source files: `models/hr_applicant_skill.py`
- Python classes: `HrApplicantSkill`
...
title hr.applicant.skill - Direct Relations
class "hr.applicant.skill" as hr_applicant_skill
class "hr.applicant" as hr_applicant
hr_applicant_skill --> hr_applicant : applicant_id
@enduml
```
