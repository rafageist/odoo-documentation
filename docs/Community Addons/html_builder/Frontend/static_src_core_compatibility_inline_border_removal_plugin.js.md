...
# static/src/core/compatibility_inline_border_removal_plugin.js

- Module: [[docs/Community Addons/html_builder/html_builder|html_builder]]
- Scope: Community Addons
- Asset kind: `js`
- Source file: `static/src/core/compatibility_inline_border_removal_plugin.js`

## Detected frontend signals

- Component classes: `CompatibilityInlineBorderRemovalPlugin`
