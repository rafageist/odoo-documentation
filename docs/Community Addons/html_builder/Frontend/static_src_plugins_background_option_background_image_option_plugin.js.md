...
- Asset kind: `js`
- Source file: `static/src/plugins/background_option/background_image_option_plugin.js`

## Detected frontend signals

- Component classes: `BackgroundImageOptionPlugin`, `DynamicColorAction`, `ReplaceBgImageAction`, `SelectFilterColorAction`, `ToggleBgImageAction`
