...
# static/src/plugins/background_option/background_position_overlay.js

- Module: [[docs/Community Addons/html_builder/html_builder|html_builder]]
- Scope: Community Addons
- Asset kind: `js`
- Source file: `static/src/plugins/background_option/background_position_overlay.js`

## Detected frontend signals

- Component classes: `BackgroundPositionOverlay`
