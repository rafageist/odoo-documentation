...
# static/src/plugins/image/image_tool_option.xml

- Module: [[docs/Community Addons/html_builder/html_builder|html_builder]]
- Scope: Community Addons
- Asset kind: `xml`
- Source file: `static/src/plugins/image/image_tool_option.xml`

## Detected frontend signals

- Component classes: none
- Registry entries: none
- Templates: `html_builder.ImageAndFaOption`, `html_builder.ImageToolOption`
