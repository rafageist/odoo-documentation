...
# static/src/plugins/image/image_transform_option.js

- Module: [[docs/Community Addons/html_builder/html_builder|html_builder]]
- Scope: Community Addons
- Asset kind: `js`
- Source file: `static/src/plugins/image/image_transform_option.js`

## Detected frontend signals

- Component classes: `ImageTransformOption`
