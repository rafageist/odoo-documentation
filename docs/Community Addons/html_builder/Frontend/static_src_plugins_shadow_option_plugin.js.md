...
# static/src/plugins/shadow_option_plugin.js

- Module: [[docs/Community Addons/html_builder/html_builder|html_builder]]
- Scope: Community Addons
- Asset kind: `js`
- Source file: `static/src/plugins/shadow_option_plugin.js`

## Detected frontend signals

- Component classes: `SetShadowAction`, `SetShadowModeAction`, `ShadowOptionPlugin`
