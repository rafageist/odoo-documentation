...
- Source files: `models/im_livechat_expertise.py`
- Python classes: `Im_LivechatExpertise`
...
- `user_ids`: `Many2many` (comodel `res.users`, compute `_compute_user_ids`, store `False`)
...
title im_livechat.expertise - Direct Relations
class "im_livechat.expertise" as im_livechat_expertise
class "res.users" as res_users
im_livechat_expertise .. res_users : user_ids
@enduml
```
