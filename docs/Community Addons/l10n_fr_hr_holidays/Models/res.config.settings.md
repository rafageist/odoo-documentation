...
- `l10n_fr_reference_leave_type`: `Many2one` (comodel `hr.leave.type`, related `company_id.l10n_fr_reference_leave_type`)
...
res_config_settings --> hr_leave_type : l10n_fr_reference_leave_type
@enduml
```
