...
- `l10n_it_edi_doi_fiscal_position_id`: `Many2one` (comodel `account.fiscal.position`)
- `l10n_it_edi_doi_tax_id`: `Many2one` (comodel `account.tax`)
...
res_company --> account_tax : l10n_it_edi_doi_tax_id
res_company --> account_fiscal_position : l10n_it_edi_doi_fiscal_position_id
@enduml
```
