...
- `l10n_ke_item_code_id`: `Many2one` (comodel `l10n_ke.item.code`)
...
- Onchange methods: `_onchange_l10n_ke_item_code_id`
...
account_tax --> l10n_ke_item_code : l10n_ke_item_code_id
@enduml
```

## Navigation

- **Parent:** [[docs/Community Addons/l10n_ke/Models]]
