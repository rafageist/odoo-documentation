...
- `is_vat`: `Boolean` (related `l10n_latam_identification_type_id.is_vat`)
- `l10n_latam_identification_type_id`: `Many2one` (comodel `l10n_latam.identification.type`)
- `vat`: `Char`
...
res_partner --> l10n_latam_identification_type : l10n_latam_identification_type_id
@enduml
```
