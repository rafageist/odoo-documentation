...
- Detected methods: 31
- Action methods: `action_l10n_ro_edi_stock_fetch_status`, `action_l10n_ro_edi_stock_send_etransport`
...
stock_picking --|> l10n_ro_edi_document : l10n_ro_edi_stock_document_ids
@enduml
```
