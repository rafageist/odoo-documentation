...
- `l10n_tr_nilvera_purchase_journal_id`: `Many2one` (comodel `account.journal`, compute `_compute_l10n_tr_nilvera_purchase_journal_id`, store `True`)
...
- Detected methods: 2
- Action methods: none
- Compute methods: `_compute_l10n_tr_nilvera_purchase_journal_id`
...
res_company --> account_journal : l10n_tr_nilvera_purchase_journal_id
@enduml
```
