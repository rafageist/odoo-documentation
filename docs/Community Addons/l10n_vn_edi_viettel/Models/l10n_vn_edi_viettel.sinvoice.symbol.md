...
- Python classes: `L10n_Vn_Edi_ViettelSinvoiceSymbol`
...
- `invoice_template_id`: `Many2one` (comodel `l10n_vn_edi_viettel.sinvoice.template`)
- `name`: `Char`
...
title l10n_vn_edi_viettel.sinvoice.symbol - Direct Relations
...
l10n_vn_edi_viettel_sinvoice_symbol --> l10n_vn_edi_viettel_sinvoice_template : invoice_template_id
@enduml
```
