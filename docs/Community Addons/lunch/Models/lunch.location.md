...
- Source files: `models/lunch_location.py`
- Python classes: `LunchLocation`
...
title lunch.location - Direct Relations
class "lunch.location" as lunch_location
class "res.company" as res_company
lunch_location --> res_company : company_id
@enduml
```
