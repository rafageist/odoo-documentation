...
- Source files: `wizard/mailing_mailing_test.py`
- Python classes: `MailingMailingTest`
...
title mailing.mailing.test - Direct Relations
class "mailing.mailing.test" as mailing_mailing_test
class "mailing.mailing" as mailing_mailing
mailing_mailing_test --> mailing_mailing : mass_mailing_id
@enduml
```
