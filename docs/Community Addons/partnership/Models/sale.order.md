...
- `assigned_grade_id`: `Many2one` (comodel `res.partner.grade`, compute `_compute_partnership`)

## Method hints

- Detected methods: 4
- Action methods: `action_confirm`
- Compute methods: `_compute_partnership`
...
sale_order --> res_partner_grade : assigned_grade_id
@enduml
```
