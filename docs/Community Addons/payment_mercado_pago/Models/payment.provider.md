...
- Module: [[docs/Community Addons/payment_mercado_pago/payment_mercado_pago|payment_mercado_pago]]
...
- `mercado_pago_account_country_id`: `Many2one` (comodel `res.country`)
...
- Detected methods: 14
- Action methods: `action_start_onboarding`
...
payment_provider --> res_country : mercado_pago_account_country_id
@enduml
```

## Navigation

- **Parent:** [[docs/Community Addons/payment_mercado_pago/Models]]
