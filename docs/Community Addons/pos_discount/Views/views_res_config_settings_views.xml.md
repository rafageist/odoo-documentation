...
- Name: res.config.settings.view.form.inherit.pos_discount
- Model: `res.config.settings`
- Type: inferred from arch
- Inherits: `point_of_sale.res_config_settings_view_form`
- Root tag: `div`
- Field references: 2
- Sample fields: `pos_discount_pc`, `pos_discount_product_id`
- XPath or positional patches: 1

## Navigation

- **Parent:** [[docs/Community Addons/pos_discount/Views]]
