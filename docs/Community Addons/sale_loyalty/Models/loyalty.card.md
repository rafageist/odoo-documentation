...
- `order_id_partner_id`: `Many2one` (comodel `res.partner`, related `order_id.partner_id`)
...
loyalty_card --> sale_order : order_id
loyalty_card --> res_partner : order_id_partner_id
@enduml
```
