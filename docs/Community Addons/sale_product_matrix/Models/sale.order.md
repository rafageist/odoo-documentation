...
- `grid`: `Char` (comodel `Matrix local storage`, store `False`)
...
sale_order --> product_template : grid_product_tmpl_id
@enduml
```

## Navigation

- **Parent:** [[docs/Community Addons/sale_product_matrix/Models]]
