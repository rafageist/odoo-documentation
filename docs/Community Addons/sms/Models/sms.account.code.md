...
- Source files: `wizard/sms_account_code.py`
- Python classes: `SmsAccountCode`
...
- Detected methods: 1
- Action methods: `action_register`
...
title sms.account.code - Direct Relations
class "sms.account.code" as sms_account_code
class "iap.account" as iap_account
sms_account_code --> iap_account : account_id
@enduml
```
