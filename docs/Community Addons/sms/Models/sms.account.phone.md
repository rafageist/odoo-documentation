...
- Source files: `wizard/sms_account_phone.py`
- Python classes: `SmsAccountPhone`
...
- Detected methods: 1
- Action methods: `action_send_verification_code`
...
title sms.account.phone - Direct Relations
class "sms.account.phone" as sms_account_phone
class "iap.account" as iap_account
sms_account_phone --> iap_account : account_id
@enduml
```
