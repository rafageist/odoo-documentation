...
# static/src/chart/odoo_chart/odoo_waterfall_chart.js

- Module: [[docs/Community Addons/spreadsheet/spreadsheet|spreadsheet]]
- Scope: Community Addons
- Asset kind: `js`
- Source file: `static/src/chart/odoo_chart/odoo_waterfall_chart.js`

## Detected frontend signals

- Component classes: `OdooWaterfallChart`
