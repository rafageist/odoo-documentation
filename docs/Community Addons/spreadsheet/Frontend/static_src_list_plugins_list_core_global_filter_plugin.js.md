...
# static/src/list/plugins/list_core_global_filter_plugin.js

- Module: [[docs/Community Addons/spreadsheet/spreadsheet|spreadsheet]]
- Scope: Community Addons
- Asset kind: `js`
- Source file: `static/src/list/plugins/list_core_global_filter_plugin.js`

## Detected frontend signals

- Component classes: `ListCoreGlobalFilterPlugin`
