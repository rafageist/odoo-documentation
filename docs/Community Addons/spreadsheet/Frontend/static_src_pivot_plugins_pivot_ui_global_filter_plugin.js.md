...
# static/src/pivot/plugins/pivot_ui_global_filter_plugin.js

- Module: [[docs/Community Addons/spreadsheet/spreadsheet|spreadsheet]]
- Scope: Community Addons
- Asset kind: `js`
- Source file: `static/src/pivot/plugins/pivot_ui_global_filter_plugin.js`

## Detected frontend signals

- Component classes: `PivotUIGlobalFilterPlugin`
