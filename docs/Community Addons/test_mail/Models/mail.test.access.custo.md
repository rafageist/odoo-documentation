...
- Python classes: `MailTestAccessCusto`
- Description: Mail Access Test with Custo
...
title mail.test.access.custo - Direct Relations
class "mail.test.access.custo" as mail_test_access_custo
class "res.partner" as res_partner
mail_test_access_custo --> res_partner : customer_id
@enduml
```
