...
- Python classes: `MailTestAccessPublic`
- Description: Access Test Public
...
title mail.test.access.public - Direct Relations
class "mail.test.access.public" as mail_test_access_public
class "res.partner" as res_partner
mail_test_access_public --> res_partner : customer_id
@enduml
```
