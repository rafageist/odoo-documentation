...
- Python classes: `MailTestGatewayGroups`
- Description: Channel/Group-like Chatter Model for Mail Gateway
- Inherits: `mail.alias.mixin`, `mail.thread.blacklist`
...
title mail.test.gateway.groups - Direct Relations
class "mail.test.gateway.groups" as mail_test_gateway_groups
class "res.partner" as res_partner
mail_test_gateway_groups --> res_partner : customer_id
@enduml
```
