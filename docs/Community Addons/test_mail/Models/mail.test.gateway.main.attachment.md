...
- Python classes: `MailTestGatewayMainAttachment`
- Description: Simple Chatter Model for Mail Gateway with company
- Inherits: `mail.test.gateway`, `mail.thread.main.attachment`
...
title mail.test.gateway.main.attachment - Direct Relations
class "mail.test.gateway.main.attachment" as mail_test_gateway_main_attachment
class "res.company" as res_company
mail_test_gateway_main_attachment --> res_company : company_id
@enduml
```
