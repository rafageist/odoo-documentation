...
- Python classes: `MailTestMultiCompanyWithActivity`
- Description: Test Multi Company Mail With Activity
...
title mail.test.multi.company.with.activity - Direct Relations
class "mail.test.multi.company.with.activity" as mail_test_multi_company_with_activity
class "res.company" as res_company
mail_test_multi_company_with_activity --> res_company : company_id
@enduml
```
