...
- Python classes: `MailTestNothread`
...
title mail.test.nothread - Direct Relations
class "mail.test.nothread" as mail_test_nothread
class "res.company" as res_company
class "res.partner" as res_partner
mail_test_nothread --> res_company : company_id
mail_test_nothread --> res_partner : customer_id
@enduml
```
