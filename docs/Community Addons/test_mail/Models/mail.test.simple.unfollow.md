...
- Python classes: `MailTestSimpleUnfollow`
- Description: Simple Chatter Model
...
title mail.test.simple.unfollow - Direct Relations
class "mail.test.simple.unfollow" as mail_test_simple_unfollow
class "res.company" as res_company
mail_test_simple_unfollow --> res_company : company_id
@enduml
```
