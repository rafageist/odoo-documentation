...
- Python classes: `MailTestSmsBl`
- Description: SMS Mailing Blacklist Enabled
- Inherits: `mail.thread.phone`

## Field footprint

- Detected fields: 6
- Field types: `Char` x 5, `Many2one` x 1
- Relation fields: 1
...
- `mobile_nbr`: `Char`
- `name`: `Char`
- `phone_nbr`: `Char` (compute `_compute_phone_nbr`, store `True`)
- `subject`: `Char`
...
- Detected methods: 3
- Action methods: none
- Compute methods: `_compute_phone_nbr`
...
title mail.test.sms.bl - Direct Relations
class "mail.test.sms.bl" as mail_test_sms_bl
class "res.partner" as res_partner
mail_test_sms_bl --> res_partner : customer_id
@enduml
```
