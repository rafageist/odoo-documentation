...
- Python classes: `MailTestSmsBlOptout`
- Description: SMS Mailing Blacklist / Optout Enabled
...
title mail.test.sms.bl.optout - Direct Relations
class "mail.test.sms.bl.optout" as mail_test_sms_bl_optout
class "res.partner" as res_partner
mail_test_sms_bl_optout --> res_partner : customer_id
@enduml
```
