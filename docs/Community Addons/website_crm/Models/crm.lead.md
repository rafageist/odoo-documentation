...
- `visitor_ids`: `Many2many` (comodel `website.visitor`)
- `visitor_page_count`: `Integer` (comodel `# Page Views`, compute `_compute_visitor_page_count`)

## Method hints

- Detected methods: 4
- Action methods: `action_redirect_to_page_views`
- Compute methods: `_compute_visitor_page_count`
...
crm_lead .. website_visitor : visitor_ids
@enduml
```
