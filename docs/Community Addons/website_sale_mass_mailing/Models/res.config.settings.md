...
- `is_newsletter_enabled`: `Boolean` (compute `_compute_is_newsletter_enabled`, store `True`)
- `newsletter_id`: `Many2one` (related `website_id.newsletter_id`)

## Method hints

- Detected methods: 2
- Action methods: none
- Compute methods: `_compute_is_newsletter_enabled`
