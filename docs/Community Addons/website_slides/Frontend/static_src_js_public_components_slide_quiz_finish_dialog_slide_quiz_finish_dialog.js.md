...
# static/src/js/public/components/slide_quiz_finish_dialog/slide_quiz_finish_dialog.js

- Module: [[docs/Community Addons/website_slides/website_slides|website_slides]]
- Scope: Community Addons
- Asset kind: `component`
- Source file: `static/src/js/public/components/slide_quiz_finish_dialog/slide_quiz_finish_dialog.js`

## Detected frontend signals

- Component classes: `SlideQuizFinishDialog`
