...
# static/src/js/public/components/slide_share_dialog/slide_share_dialog.js

- Module: [[docs/Community Addons/website_slides/website_slides|website_slides]]
- Scope: Community Addons
- Asset kind: `component`
- Source file: `static/src/js/public/components/slide_share_dialog/slide_share_dialog.js`

## Detected frontend signals

- Component classes: `SlideShareDialog`
