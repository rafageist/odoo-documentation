...
- Name: res.config.settings.view.form.inherit.account.intrastat
- Model: `res.config.settings`
- Type: inferred from arch
- Inherits: `account.res_config_settings_view_form`
- Root tag: `xpath`
- Field references: 5
- Sample fields: `company_country_id`, `has_country_regions`, `intrastat_default_invoice_transaction_code_id`, `intrastat_default_refund_transaction_code_id`, `intrastat_region_id`
