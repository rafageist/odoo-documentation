...
- `sdd_count`: `Integer` (compute `_compute_sdd_count`)
- `sdd_mandate_ids`: `One2many` (comodel `sdd.mandate`)

## Method hints

- Detected methods: 3
- Action methods: `action_open_ssd_mandates`
- Compute methods: `_compute_sdd_count`
...
res_partner --|> sdd_mandate : sdd_mandate_ids
@enduml
```
