...
### `res_config_settings_view_form_stock_shiprocket`
- Name: res.config.settings.view.form.inherit.delivery.shiprocket.stock
...
### `res_config_settings_view_form_sale_shiprocket`
- Name: res.config.settings.view.form.inherit.delivery.shiprocket.sale
- Model: `res.config.settings`
- Type: inferred from arch
