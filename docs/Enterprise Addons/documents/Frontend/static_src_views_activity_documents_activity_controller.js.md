...
# static/src/views/activity/documents_activity_controller.js

- Module: [[docs/Enterprise Addons/documents/documents|documents]]
- Scope: Enterprise Addons
- Asset kind: `view`
- Source file: `static/src/views/activity/documents_activity_controller.js`

## Detected frontend signals

- Component classes: `DocumentsActivityController`
