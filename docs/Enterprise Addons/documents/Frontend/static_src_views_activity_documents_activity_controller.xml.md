...
# static/src/views/activity/documents_activity_controller.xml

- Module: [[docs/Enterprise Addons/documents/documents|documents]]
- Scope: Enterprise Addons
- Asset kind: `view`
- Source file: `static/src/views/activity/documents_activity_controller.xml`

## Detected frontend signals

- Component classes: none
- Registry entries: none
- Templates: `documents.DocumentsActivityController`
