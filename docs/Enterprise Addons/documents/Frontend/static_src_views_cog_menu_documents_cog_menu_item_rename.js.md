...
# static/src/views/cog_menu/documents_cog_menu_item_rename.js

- Module: [[docs/Enterprise Addons/documents/documents|documents]]
- Scope: Enterprise Addons
- Asset kind: `view`
- Source file: `static/src/views/cog_menu/documents_cog_menu_item_rename.js`

## Detected frontend signals

- Component classes: `DocumentsCogMenuItemRename`
