...
# static/src/views/widget/documents_operation_confirmation.xml

- Module: [[docs/Enterprise Addons/documents/documents|documents]]
- Scope: Enterprise Addons
- Asset kind: `view`
- Source file: `static/src/views/widget/documents_operation_confirmation.xml`

## Detected frontend signals

- Component classes: none
- Registry entries: none
- Templates: `documents.DocumentsOperationConfirmation`
