...
- `documents_hr_payslips_tags`: `Many2many` (comodel `documents.tag`, related `company_id.documents_hr_payslips_tags`)
...
res_config_settings .. documents_tag : documents_hr_payslips_tags
@enduml
```
