...
- Source file: `report/helpdesk_sla_analysis_views.xml`
- Views: 1
- Actions: 0
- Menus: 0
- Rules: 0
...
### `view_helpdesk_sla_pivot_analysis`
- Name: helpdesk.sla.report.analysis.pivot.inherited
- Model: `helpdesk.sla.report.analysis`
- Type: inferred from arch
- Inherits: `helpdesk.helpdesk_sla_report_analysis_view_pivot`
- Root tag: `field`
- Field references: 2
- Sample fields: `remaining_hours_so`, `ticket_assignation_hours`
