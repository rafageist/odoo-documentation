...
helpdesk_sla_report_analysis --> hr_department : department_id
helpdesk_sla_report_analysis --> hr_employee : manager_id
helpdesk_sla_report_analysis --> hr_employee : employee_id
@enduml
```
