...
- Source files: `models/hr_appraisal_note.py`
- Python classes: `HrAppraisalNote`
- Description: Appraisal Assessment Note
...
title hr.appraisal.note - Direct Relations
class "hr.appraisal.note" as hr_appraisal_note
class "res.company" as res_company
hr_appraisal_note --> res_company : company_id
@enduml
```
