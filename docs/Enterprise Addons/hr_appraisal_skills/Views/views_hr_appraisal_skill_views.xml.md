...
- Source file: `views/hr_appraisal_skill_views.xml`
- Views: 1
- Actions: 0
- Menus: 0
- Rules: 0
...
### `hr_appraisal_skills_view_form`
- Name: hr.appraisal.skill.view.form
- Model: `hr.appraisal.skill`
- Type: inferred from arch
- Root tag: `form`
- Field references: 5
- Sample fields: `skill_id`, `skill_level_id`, `skill_type_id`, `valid_from`, `valid_to`
