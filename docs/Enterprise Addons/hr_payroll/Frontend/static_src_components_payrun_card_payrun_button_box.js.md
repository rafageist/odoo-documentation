...
# static/src/components/payrun_card/payrun_button_box.js

- Module: [[docs/Enterprise Addons/hr_payroll/hr_payroll|hr_payroll]]
- Scope: Enterprise Addons
- Asset kind: `component`
- Source file: `static/src/components/payrun_card/payrun_button_box.js`

## Detected frontend signals

- Component classes: `PayRunButtonBox`
