...
- Python classes: `ProjectTaskStopTimersWizardLine`
- Description: Task stop running timers confirmation wizard line
...
- `wizard_id`: `Many2one` (comodel `project.task.stop.timers.wizard`)
...
title project.task.stop.timers.wizard.line - Direct Relations
...
project_task_stop_timers_wizard_line --> project_task_stop_timers_wizard : wizard_id
project_task_stop_timers_wizard_line --> project_task : task_id
@enduml
```
