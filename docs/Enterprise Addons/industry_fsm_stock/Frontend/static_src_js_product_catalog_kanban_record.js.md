...
# static/src/js/product_catalog/kanban_record.js

- Module: [[docs/Enterprise Addons/industry_fsm_stock/industry_fsm_stock|industry_fsm_stock]]
- Scope: Enterprise Addons
- Asset kind: `js`
- Source file: `static/src/js/product_catalog/kanban_record.js`
...
- **Parent:** [[docs/Enterprise Addons/industry_fsm_stock/Frontend]]
