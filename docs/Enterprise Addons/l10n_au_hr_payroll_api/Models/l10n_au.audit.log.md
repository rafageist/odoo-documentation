...
- Source files: `models/l10n_au_audit_log.py`
- Python classes: `L10n_AuAuditLog`
- Description: Audit Log for Payroll
...
title l10n_au.audit.log - Direct Relations
class "l10n_au.audit.log" as l10n_au_audit_log
class "res.company" as res_company
l10n_au_audit_log --> res_company : company_id
@enduml
```
