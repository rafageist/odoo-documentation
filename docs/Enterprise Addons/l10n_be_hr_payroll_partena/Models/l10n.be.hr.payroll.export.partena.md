...
- Python classes: `L10nBeHrPayrollExportPartena`
- Description: Export Payroll to Partena
...
- `eligible_employee_line_ids`: `One2many` (comodel `l10n.be.hr.payroll.export.partena.employee`)
...
title l10n.be.hr.payroll.export.partena - Direct Relations
...
l10n_be_hr_payroll_export_partena --|> l10n_be_hr_payroll_export_partena_employee : eligible_employee_line_ids
@enduml
```
