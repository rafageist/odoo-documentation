...
- Python classes: `L10nChAccidentInsuranceLine`
- Description: Swiss: Accident Insurances Line (AAP/AANP)
...
- `insurance_id`: `Many2one` (comodel `l10n.ch.accident.insurance`)
- `rate_ids`: `One2many` (comodel `l10n.ch.accident.insurance.line.rate`)
- `solution_code`: `Char` (compute `_compute_solution_code`, store `True`)
- `solution_name`: `Char`
...
title l10n.ch.accident.insurance.line - Direct Relations
...
l10n_ch_accident_insurance_line --> l10n_ch_accident_insurance : insurance_id
l10n_ch_accident_insurance_line --|> l10n_ch_accident_insurance_line_rate : rate_ids
@enduml
```
