...
- Python classes: `L10nChAdditionalAccidentInsuranceLine`
- Description: Swiss: Additional Accident Insurances Line (LAAC)
...
- `insurance_id`: `Many2one` (comodel `l10n.ch.additional.accident.insurance`)
- `rate_ids`: `One2many` (comodel `l10n.ch.additional.accident.insurance.line.rate`)
...
title l10n.ch.additional.accident.insurance.line - Direct Relations
...
l10n_ch_additional_accident_insurance_line --> l10n_ch_additional_accident_insurance : insurance_id
l10n_ch_additional_accident_insurance_line --|> l10n_ch_additional_accident_insurance_line_rate : rate_ids
@enduml
```
