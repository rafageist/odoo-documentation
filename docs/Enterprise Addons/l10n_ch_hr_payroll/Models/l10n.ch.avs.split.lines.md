...
- Python classes: `L10nChAvsIncomeSplitLines`
- Description: AVS Income Split Lines
...
- `avs_split_id`: `Many2one` (comodel `l10n.ch.avs.splits`)
- `date_from`: `Date`
- `date_to`: `Date`
- `income`: `Float`
