...
- Python classes: `l10nChLppInsuranceSolution`
- Description: LPP Solutions
...
- `code`: `Char`
- `institution_id`: `Many2one` (comodel `l10n.ch.lpp.insurance`)
- `name`: `Char`
