...
- Python classes: `L10nChSocialInsuranceAvsAcThreshold`
- Description: Swiss: AC: Rate Threshold
...
title l10n.ch.social.insurance.avs.ac.threshold - Direct Relations
...
l10n_ch_social_insurance_avs_ac_threshold --> l10n_ch_social_insurance : insurance_id
@enduml
```
