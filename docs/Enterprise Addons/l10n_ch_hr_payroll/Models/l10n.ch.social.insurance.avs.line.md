...
- Python classes: `L10nChSocialInsuranceAvsLine`
- Description: Swiss: Social Insurances - AVS Line

## Field footprint

- Detected fields: 6
- Field types: `Date` x 2, `Float` x 3, `Many2one` x 1
- Relation fields: 1
...
title l10n.ch.social.insurance.avs.line - Direct Relations
...
l10n_ch_social_insurance_avs_line --> l10n_ch_social_insurance : insurance_id
@enduml
```
