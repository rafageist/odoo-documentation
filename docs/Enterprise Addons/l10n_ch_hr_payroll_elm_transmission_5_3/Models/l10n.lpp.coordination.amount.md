...
- Description: BVG/LPP Coordination values

## Field footprint

- Detected fields: 5
- Field types: `Date` x 2, `Float` x 2, `Many2one` x 1
- Relation fields: 1
...
- `date_from`: `Date`
- `date_to`: `Date`
- `insurance_id`: `Many2one` (comodel `l10n.ch.lpp.insurance`)
- `lpp_coordination_deduction`: `Float`
- `lpp_maximum_amount`: `Float`
