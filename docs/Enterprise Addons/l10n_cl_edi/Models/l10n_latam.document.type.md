...
- `l10n_cl_dte_caf_ids`: `One2many` (comodel `l10n_cl.dte.caf`)
- `l10n_cl_show_caf_button`: `Boolean` (compute `_l10n_cl_show_caf_button`)
...
l10n_latam_document_type --|> l10n_cl_dte_caf : l10n_cl_dte_caf_ids
@enduml
```
