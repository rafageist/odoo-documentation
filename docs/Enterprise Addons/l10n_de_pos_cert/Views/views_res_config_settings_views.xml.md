...
- Name: res.config.settings.view.form.inherit.l10n_de_pos_cert
- Model: `res.config.settings`
- Type: inferred from arch
- Inherits: `point_of_sale.res_config_settings_view_form`
- Root tag: `xpath`
- Field references: 4
- Sample fields: `pos_is_company_country_germany`, `pos_l10n_de_create_tss_flag`, `pos_l10n_de_fiskaly_client_id`, `pos_l10n_de_fiskaly_tss_id`
