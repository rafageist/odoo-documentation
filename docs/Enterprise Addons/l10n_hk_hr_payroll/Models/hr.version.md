...
- Detected fields: 4
- Field types: `Float` x 1, `Many2one` x 1, `Monetary` x 1, `Selection` x 1
- Relation fields: 1

## Sample fields

- `l10n_hk_internet`: `Monetary`
- `l10n_hk_mpf_vc_option`: `Selection`
- `l10n_hk_mpf_vc_percentage`: `Float`
- `l10n_hk_rental_id`: `Many2one` (comodel `l10n_hk.rental`)
...
hr_version --> l10n_hk_rental : l10n_hk_rental_id
@enduml
```
