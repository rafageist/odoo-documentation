...
- Name: res.config.settings.view.form.inherit.l10n_hk_hr_payroll_empf
- Model: `res.config.settings`
- Type: inferred from arch
- Inherits: `l10n_hk_hr_payroll.res_config_settings_view_form`
- Root tag: `xpath`
- Field references: 0
- Buttons: `open_mpf_scheme_list`
