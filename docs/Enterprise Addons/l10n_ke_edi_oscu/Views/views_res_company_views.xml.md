...
### `res_company_form_inherit_l10n_ke_edi_oscu`
- Name: res.company.form.inherit.l10n.ke.edi.oscu
- Model: `res.company`
- Type: inferred from arch
- Inherits: `base.view_company_form`
- Root tag: `field`
- Field references: 3
- Sample fields: `child_ids`, `l10n_ke_branch_code`, `vat`
- Buttons: `action_l10n_ke_create_branches`
