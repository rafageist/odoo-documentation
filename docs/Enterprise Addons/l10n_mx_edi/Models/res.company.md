...
- `l10n_mx_edi_certificate_ids`: `One2many` (comodel `certificate.certificate`)
- `l10n_mx_edi_fiscal_regime`: `Selection`
- `l10n_mx_edi_pac`: `Selection`
- `l10n_mx_edi_pac_password`: `Char`
- `l10n_mx_edi_pac_test_env`: `Boolean`
- `l10n_mx_edi_pac_username`: `Char`
...
res_company --|> certificate_certificate : l10n_mx_edi_certificate_ids
@enduml
```
