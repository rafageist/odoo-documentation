...
- Source files: `models/l10n_mx_edi_locality.py`
- Python classes: `L10n_Mx_EdiResLocality`
...
title l10n_mx_edi.res.locality - Direct Relations
class "l10n_mx_edi.res.locality" as l10n_mx_edi_res_locality
class "res.country" as res_country
class "res.country.state" as res_country_state
l10n_mx_edi_res_locality --> res_country : country_id
l10n_mx_edi_res_locality --> res_country_state : state_id
@enduml
```
