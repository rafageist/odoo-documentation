...
- `l10n_mx_edi_tariff_fraction_id`: `Many2one` (comodel `l10n_mx_edi.tariff.fraction`)
- `l10n_mx_edi_umt_aduana_id`: `Many2one` (comodel `uom.uom`)
...
product_template --> l10n_mx_edi_tariff_fraction : l10n_mx_edi_tariff_fraction_id
product_template --> uom_uom : l10n_mx_edi_umt_aduana_id
@enduml
```
