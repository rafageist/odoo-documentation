...
- `l10n_mx_edi_can_use_customs_invoicing`: `Boolean` (compute `_compute_l10n_mx_edi_can_use_customs_invoicing`)

## Method hints

- Detected methods: 1
- Action methods: none
- Compute methods: `_compute_l10n_mx_edi_can_use_customs_invoicing`
