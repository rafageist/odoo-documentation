...
- `l10n_sa_annual_leave_type_id`: `Many2one` (comodel `hr.leave.type`)
- `l10n_sa_bank_account_id`: `Many2one` (comodel `res.partner.bank`)
- `l10n_sa_mol_establishment_code`: `Char`
...
res_company --> res_partner_bank : l10n_sa_bank_account_id
res_company --> hr_leave_type : l10n_sa_annual_leave_type_id
@enduml
```
