...
- Name: res.config.settings.view.form.inherit.l10n_us_hr_payroll_adp
- Model: `res.config.settings`
- Type: inferred from arch
- Inherits: `l10n_us_hr_payroll.res_config_settings_view_form`
- Root tag: `xpath`
- Field references: 1
- Sample fields: `l10n_us_adp_code`
