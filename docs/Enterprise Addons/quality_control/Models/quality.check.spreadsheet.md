...
- Source files: `models/quality_check_spreadsheet.py`
- Python classes: `QualityCheckSpreadsheet`
- Description: Quality check spreadsheet
...
title quality.check.spreadsheet - Direct Relations
class "quality.check.spreadsheet" as quality_check_spreadsheet
class "res.company" as res_company
quality_check_spreadsheet --> res_company : company_id
@enduml
```
