...
- `qcp_test_type`: `Char` (compute `_compute_qcp_test_type`)
...
- Detected methods: 1
- Action methods: none
- Compute methods: `_compute_qcp_test_type`
...
iot_device --|> quality_point : quality_point_ids
@enduml
```
