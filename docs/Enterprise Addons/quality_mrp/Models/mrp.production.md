...
- `quality_check_todo`: `Boolean` (compute `_compute_check`)

## Method hints

- Detected methods: 10
- Action methods: `action_cancel`, `action_open_on_demand_quality_check`
...
mrp_production --|> quality_alert : quality_alert_ids
@enduml
```
