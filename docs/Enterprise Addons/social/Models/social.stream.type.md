...
- Source files: `models/social_stream_type.py`
- Python classes: `SocialStreamType`
...
- `stream_type`: `Char` (comodel `Stream type name (technical)`)
...
title social.stream.type - Direct Relations
class "social.stream.type" as social_stream_type
class "social.media" as social_media
social_stream_type --> social_media : media_id
@enduml
```
