...
- Python classes: `MarketingTestUtm`
- Description: MarketAuto: simple thread-enabled model with UTMs
- Inherits: `mail.thread`, `utm.mixin`
...
title marketing.test.utm - Direct Relations
class "marketing.test.utm" as marketing_test_utm
class "res.partner" as res_partner
marketing_test_utm --> res_partner : partner_id
@enduml
```
