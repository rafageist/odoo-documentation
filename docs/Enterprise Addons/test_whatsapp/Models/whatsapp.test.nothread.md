...
- Python classes: `WhatsappTestNothread`
- Description: WhatsApp NoThread / NoResponsible
...
title whatsapp.test.nothread - Direct Relations
class "whatsapp.test.nothread" as whatsapp_test_nothread
class "res.country" as res_country
class "res.partner" as res_partner
class "res.users" as res_users
whatsapp_test_nothread --> res_country : country_id
whatsapp_test_nothread --> res_partner : customer_id
whatsapp_test_nothread --> res_users : user_id
@enduml
```
