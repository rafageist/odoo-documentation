...
# static/src/client_action/editor/new_view_dialogs/new_view_dialog.js

- Module: [[docs/Enterprise Addons/web_studio/web_studio|web_studio]]
- Scope: Enterprise Addons
- Asset kind: `js`
- Source file: `static/src/client_action/editor/new_view_dialogs/new_view_dialog.js`

## Detected frontend signals

- Component classes: `NewViewDialog`
