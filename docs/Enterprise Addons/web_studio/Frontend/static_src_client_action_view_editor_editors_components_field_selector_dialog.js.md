...
# static/src/client_action/view_editor/editors/components/field_selector_dialog.js

- Module: [[docs/Enterprise Addons/web_studio/web_studio|web_studio]]
- Scope: Enterprise Addons
- Asset kind: `component`
- Source file: `static/src/client_action/view_editor/editors/components/field_selector_dialog.js`

## Detected frontend signals

- Component classes: `FieldSelectorDialog`
