...
# static/src/client_action/view_editor/editors/components/view_button_studio.js

- Module: [[docs/Enterprise Addons/web_studio/web_studio|web_studio]]
- Scope: Enterprise Addons
- Asset kind: `component`
- Source file: `static/src/client_action/view_editor/editors/components/view_button_studio.js`

## Detected frontend signals

- Component classes: `ViewButtonStudio`
