...
# static/src/client_action/view_editor/editors/components/view_fields.js

- Module: [[docs/Enterprise Addons/web_studio/web_studio|web_studio]]
- Scope: Enterprise Addons
- Asset kind: `component`
- Source file: `static/src/client_action/view_editor/editors/components/view_fields.js`

## Detected frontend signals

- Component classes: `ExistingFields`, `NewFields`
