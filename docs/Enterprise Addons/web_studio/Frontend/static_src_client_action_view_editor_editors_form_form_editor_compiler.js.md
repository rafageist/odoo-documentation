...
# static/src/client_action/view_editor/editors/form/form_editor_compiler.js

- Module: [[docs/Enterprise Addons/web_studio/web_studio|web_studio]]
- Scope: Enterprise Addons
- Asset kind: `js`
- Source file: `static/src/client_action/view_editor/editors/form/form_editor_compiler.js`

## Detected frontend signals

- Component classes: `FormEditorCompiler`
